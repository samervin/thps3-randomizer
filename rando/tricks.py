...
class Tricks:
    def _get_regular_tricks_by_type(self, by_trick_type):
        return [
            t
            for t in self.all_tricks
            if t.trick_type == by_trick_type
            and t.is_special is False
            and t.is_extra is False
        ]
    ...
    def get_all_special_tricks(self):
        return [
            t for t in self.all_tricks if t.is_special is True and t.is_extra is False
        ]
    ...
    all_tricks = [  # TODO: Not actually all tricks yet!
        ...
        Trick(
            ...
            "Crook BigSpin Crook Grind",
            "grind",
            is_special=True,
        ),
        Trick(
            "Darkslide", "Trick_DarkSlide", "Darkslide Grind", "grind", is_special=True
        ),
        Trick(
            "Fandangle", "Trick_Fandangle", "Fandangle Grind", "grind", is_special=True
        ),
        Trick(
            "Handstand 50-50",
            "Trick_Handstand5050",
            "Handstand 50-50 Grind",
            "grind",
            is_special=True,
        ),
        Trick(
        ...
        Trick(
            "Hurricane", "Trick_Hurricane", "Hurricane Grind", "grind", is_special=True
        ),
        Trick(
            "Layback",
            "Trick_FeebleLayback",
            "Layback Sparks Grind",
            "grind",
            is_special=True,
        ),
        Trick(
        ...
        Trick(
            "Judo Madonna", "Trick_JudoMadonna", "Judo Madonna", "grab", is_special=True
        ),
        Trick(
        ...
        Trick(
            ...
            "Trick_FFImpossible",
            "Front Foot Impossible Flip",
            "flip",
        ),
        Trick(
            "FS Shove-It", "Trick_FSShoveIt", "FS Shove-It Flip", "flip"
        ),  # TODO: 360/540 fs shove-it
        Trick("Hardflip", "Trick_Hardflip", "Hardflip", "flip"),
        Trick(
            "Heelflip Varial Lien", "Trick_HFVarialLien", "Heelflip Varial Lien", "flip"
        ),
        Trick(
            "Heelflip", "Trick_Heelflip", "Heelflip", "flip"
        ),  # TODO: double/triple heelflip
        Trick(
            "Impossible", "Trick_Impossible", "Impossible Flip", "flip"
        ),  # TODO: double/triple impossible
        Trick("Inward Heelflip", "Trick_InwardHeelflip", "Inward Heelflip", "flip"),
        Trick(
            "Kickflip", "Trick_Kickflip", "Kickflip", "flip"
        ),  # TODO: double/triple kickflip
        Trick("Ollie Airwalk", "Trick_OllieAirwalk", "Ollie Airwalk Flip", "flip"),
        Trick("Ollie North", "Trick_OllieNorth", "Ollie North Flip", "flip"),
        Trick(
            "Pop Shove-It", "Trick_PopShoveIt", "Pop Shove-It Flip", "flip"
        ),  # TODO: 360/540 shove-it
        ...
        Trick(
            "360 Hardflip", "Trick_360Hardflip", "360 HardFlip", "flip", is_special=True
        ),
        Trick("540 Flip", "Trick_540Flip", "540 Flip", "flip", is_special=True),
        Trick(
            "540 Tailwhip", "Trick_540TailWhip", "540 Tailwhip", "flip", is_special=True
        ),
        Trick(
            "Double Kickflip Indy",
            "Trick_DoubleKFindy",
            "Double Kickflip Indy",
            "flip",
            is_special=True,
        ...
        # Regular lips
        Trick(
            "Nose Stall", None, "Nose Stall Lip", "lip", is_special=False, is_extra=True
        ),  # Default lip trick, cannot normally be rebound
        ...
        Trick(
            ...
            "Trick_Invert",
            "Varial Invert to Fakie Lip",
            "lip",
        ),
        # Special lips
        Trick(
            "Bigspin Flip to Tail",
            "Trick_BigSpinFliptoTail",
            "Bigspin Flip to Tail Lip",
            "lip",
            is_special=True,
        ),
        Trick(
        ...
        Trick(
            "Handstand 360 Hand Flip",
            "Trick_HandStand50Flip",
            "Handstand 360 Hand Flip Manual",
            "manual",
            is_special=True,
        ),
        Trick(
            "Handstand Double Flip",
            "Trick_HandstandDoubleFlip",
            "Handstand Double Flip Manual",
            "manual",
            is_special=True,
        ),
        Trick(
            "One Wheel Nosemanual",
        ...
        Trick(
            "ZZZZ Manual", "Trick_ZZZZManual", "ZZZZ Manual", "manual", is_special=True
        ),
    ]
