    ...
    def shuffle_pedestrian_location_vectors(self, data):
        ...
        default_skater_vectors = [
            (
                ...
                -254.02527,
                -2167.938,
            ),  # bully02 / proxim04 / LEVEL_FLAG_PED_5 / "bully2"
            (
                -1112.4061,
                -192.00003,
                75.853546,
            ),  # bully04 / proxim05 / LEVEL_FLAG_PED_4 / "bully4"
            (
                -691.54285,
                -180.00003,
                -3252.4006,
            ),  # bully06 / proxim03 / LEVEL_FLAG_PED_3 / "bully3"
            (
                -913.89844,
                -300.96082,
                -6270.0073,
            ),  # bully07 / proxim01 / LEVEL_FLAG_PED_2 / "bully2"
            (
                2315.6704,
                -180.00003,
                -6188.2744,
            ),  # bully08 / proxim02 / LEVEL_FLAG_PED_1 / "bully1"
        ...
        for i in [1, 2, 3, 4, 5]:
            ...
            data = data.replace(
                "{{" + f"rando_can_vector_bully{i}" + "}}", vector_value
            )
