...
class THPS3Randomizer:
    ...
    def read_modified_script_qbs(self):
        ...
        self.airtricks_qb = self.read_modified_script_qb("airtricks")
        self.ajc_scripts_qb = self.read_modified_script_qb("ajc_scripts")
        self.alf_scripts_qb = self.read_modified_script_qb("alf_scripts")
        self.bdj_scripts_qb = self.read_modified_script_qb("bdj_scripts")
        self.boardselect_qb = self.read_modified_script_qb("boardselect")
        self.cjr_scripts_qb = self.read_modified_script_qb("cjr_scripts")
        self.comp_scripts_qb = self.read_modified_script_qb("comp_scripts")
        self.cpf_scripts_qb = self.read_modified_script_qb("cpf_scripts")
        self.game_qb = self.read_modified_script_qb("game")
        self.gameflow_qb = self.read_modified_script_qb("gameflow")
        self.gamemode_qb = self.read_modified_script_qb("gamemode")
        self.goal_scripts_qb = self.read_modified_script_qb("goal_scripts")
        self.judges_qb = self.read_modified_script_qb("judges")
        self.levels_qb = self.read_modified_script_qb("levels")
        self.mainmenu_qb = self.read_modified_script_qb("mainmenu")
        self.protricks_qb = self.read_modified_script_qb("protricks")
    ...
    def write_modified_script_outfiles(self):
        ...
        self.write_modified_script_outfile("alf_scripts", self.alf_scripts_qb)
        self.write_modified_script_outfile("bdj_scripts", self.bdj_scripts_qb)
        self.write_modified_script_outfile("boardselect", self.boardselect_qb)
        self.write_modified_script_outfile("cjr_scripts", self.cjr_scripts_qb)
        self.write_modified_script_outfile("comp_scripts", self.comp_scripts_qb)
        self.write_modified_script_outfile("cpf_scripts", self.cpf_scripts_qb)
        self.write_modified_script_outfile("game", self.game_qb)
        self.write_modified_script_outfile("gameflow", self.gameflow_qb)
        self.write_modified_script_outfile("gamemode", self.gamemode_qb)
        self.write_modified_script_outfile("goal_scripts", self.goal_scripts_qb)
        self.write_modified_script_outfile("judges", self.judges_qb)
        self.write_modified_script_outfile("levels", self.levels_qb)
        self.write_modified_script_outfile("mainmenu", self.mainmenu_qb)
    ...
    def get_level_order(self, shuffle: bool, end_on_comp: bool) -> list[Level2]:
        ...
        if not shuffle:
            return levels
        if not end_on_comp:
            return self._shuffle(levels)
        else:
            comp_levels = self._shuffle(
                [
                    LevelRio(),
                    LevelSkaterIsland(),
                    LevelTokyo(),
        ...
        for level in levels:
            match level.name_flag:
                ...
                case "RIO":
                    ...
                    self.comp_scripts_qb = self.comp_scripts_qb.replace(
    ...
    def set_deck_required_for_medal(self, require_deck_for_medal: bool):
        ...
        if require_deck_for_medal:
            self.judges_qb = self.judges_qb.replace(
    ...
    def set_level_time(self, min_level_time: int, max_level_time: int):
        ...
        self.gamemode_qb = self.gamemode_qb.replace(
    ...
    def randomize(
        ...
        self.display_victory_requirements()
        self.set_level_unlock_requirements(
            levels, minimum_unlock_goals, maximum_unlock_goals
        )
        self.set_score_goals(
            levels,
            score_shuffle,
            min_sick_score,
            max_sick_score,
        ...
        self.set_starting_stats(stat_default)
        ...
        self.skater_profile_qb = rando2.randomize_special_tricks(
            self.skater_profile_qb, "easy"
        )
        (
            self.ajc_scripts_qb,
            self.bdj_scripts_qb,
        ...
        self.cjr_scripts_qb = rando2.randomize_foundry_trickspot_gaps(
            self.cjr_scripts_qb
        )

        self.write_modified_script_outfiles()
