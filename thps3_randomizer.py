...
def randomize():
    ...
    script_qbs.goal_scripts_qb, script_qbs.mainmenu_qb = rando2.randomize_level_requirements(
        levels, script_qbs.mainmenu_qb, script_qbs.goal_scripts_qb)
    script_qbs.comp_scripts_qb, script_qbs.goal_scripts_qb = rando2.randomize_score_goals(
    ...
    script_qbs.skater_profile_qb = rando2.randomize_trickstyle(script_qbs.skater_profile_qb)
    script_qbs.gamemode_qb = rando2.randomize_level_timer(script_qbs.gamemode_qb)
    trickspot_tricks, script_qbs.ajc_scripts_qb, script_qbs.alf_scripts_qb, \
        script_qbs.bdj_scripts_qb, script_qbs.cjr_scripts_qb, script_qbs.cpf_scripts_qb = \
            rando2.randomize_trickspot_tricks(
                "wild", script_qbs.ajc_scripts_qb, script_qbs.alf_scripts_qb, 
                script_qbs.bdj_scripts_qb, script_qbs.cjr_scripts_qb, 
                script_qbs.cpf_scripts_qb)
    script_qbs.protricks_qb = rando2.randomize_trick_sets(script_qbs.protricks_qb, trickspot_tricks)
    script_qbs.skater_profile_qb = rando2.randomize_special_tricks(script_qbs.skater_profile_qb, "easy")
    script_qbs.ajc_scripts_qb, script_qbs.bdj_scripts_qb, script_qbs.sk3_pedscripts_qb = \
        rando2.randomize_impress_ped_scores(script_qbs.ajc_scripts_qb, 
    ...
    script_qbs.goal_scripts_qb = rando2.require_deck_for_tape(script_qbs.goal_scripts_qb)
    ...
    script_qbs.airtricks_qb = rando2.unlock_trick_scores(script_qbs.airtricks_qb, levels)
    ...
    script_qbs.cjr_scripts_qb = rando2.randomize_foundry_trickspot_gaps(script_qbs.cjr_scripts_qb)
